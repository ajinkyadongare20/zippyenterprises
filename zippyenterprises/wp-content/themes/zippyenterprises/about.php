        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <h1 class="mb-4">About Us Heading</h1>
        ...
        <div class="container pt-5">
            <div class="row g-5">
                <div class="col-lg-6 align-self-center mb-md-5 pb-md-5 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <h1 class="text-white mb-4">Why Choose Us Heading</h1>
                ...
                <div class="col-lg-6 align-self-end text-center text-md-end wow fadeIn" data-wow-delay="0.5s">
                    <img class="img-fluid" src="img/hero-img.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-3 wow fadeIn" data-wow-delay="0.3s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        ...
                                        <h5 class="mb-0">Harshad Khadse</h5>
                                ...
                                <div class="col-3 wow fadeIn" data-wow-delay="0.7s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">

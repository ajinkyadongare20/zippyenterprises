...
<head>
    <meta charset="utf-8">
    <title>Zippy Enterprises</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="<?php bloginfo('template_directory'); ?>/img/logo.jpg" rel="icon">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                <a href="index.html" class="navbar-brand">
                    <img src="<?php bloginfo('template_directory'); ?>/img/logo.jpg" alt="Logo" style="height: 70px;">
                </a>
